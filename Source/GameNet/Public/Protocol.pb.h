...
GAMENET_API extern SC_MOVE_PATHDefaultTypeInternal _SC_MOVE_PATH_default_instance_;
class SC_PONG;
...
template<> GAMENET_API ::Protocol::SC_MOVE_PATH* Arena::CreateMaybeMessage<::Protocol::SC_MOVE_PATH>(Arena*);
...
class GAMENET_API SC_MOVE_PATH final :
