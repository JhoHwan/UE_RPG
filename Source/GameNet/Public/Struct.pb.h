...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_Struct_2eproto GAMENET_API
...
struct GAMENET_API TableStruct_Struct_2eproto {
  static const uint32_t offsets[];
};
GAMENET_API extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Struct_2eproto;
namespace Protocol {
class ObjectInfo;
struct ObjectInfoDefaultTypeInternal;
GAMENET_API extern ObjectInfoDefaultTypeInternal _ObjectInfo_default_instance_;
class PlayerInfo;
struct PlayerInfoDefaultTypeInternal;
GAMENET_API extern PlayerInfoDefaultTypeInternal _PlayerInfo_default_instance_;
class Vector3;
struct Vector3DefaultTypeInternal;
GAMENET_API extern Vector3DefaultTypeInternal _Vector3_default_instance_;
}  // namespace Protocol
PROTOBUF_NAMESPACE_OPEN
template<> GAMENET_API ::Protocol::ObjectInfo* Arena::CreateMaybeMessage<::Protocol::ObjectInfo>(Arena*);
template<> GAMENET_API ::Protocol::PlayerInfo* Arena::CreateMaybeMessage<::Protocol::PlayerInfo>(Arena*);
template<> GAMENET_API ::Protocol::Vector3* Arena::CreateMaybeMessage<::Protocol::Vector3>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Protocol {

// ===================================================================

class GAMENET_API Vector3 final :
...
class GAMENET_API ObjectInfo final :
...
class GAMENET_API PlayerInfo final :
