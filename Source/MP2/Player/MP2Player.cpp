...
void AMP2Player::PossessedBy(AController* NewController)
{
...
void AMP2Player::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	{
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMP2Player::Move);
		EnhancedInputComponent->BindAction(ZoomAction, ETriggerEvent::Triggered, this, &AMP2Player::Zoom);


	}
}

void AMP2Player::Move(const FInputActionValue& Value)
{
...
void AMP2Player::Zoom(const FInputActionValue& Value)
{
